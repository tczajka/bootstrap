...
`#6e` | `#10006e` | `%001 %301`     | `add ecx, eax`
`#70` | `#100070` | `%051 %302`     | `sub edx, eax`
`#72` | `#100072` | `$75 write_loop - *` | `jnz write_loop`
`#74` | `#100074` |                 | `exit_success:`
`#76` | `#100074` | `%061 %333`     | `xor ebx, ebx`
`#76` | `#100076` |                 | `exit:`
...
> \0270\x4\0\0\0\\0315\x80\0205\0300\x7e\x8\01\0301\051\0302\x75\xef\
> \061\0333\0270\x1\0\0\0\0315\x80Hello, world\x21\xa" > bin/hello.1
$ wc -l bin/hello.1
139 bin/hello.1
