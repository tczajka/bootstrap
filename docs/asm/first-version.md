...
[`src/asm.1.echo`](https://github.com/tczajka/brooklyn/blob/main/src/asm.1.echo)
...
[`src/test.1.asm`](https://github.com/tczajka/brooklyn/blob/main/test/test.1.asm)
...
[`test/test.2.asm`](https://github.com/tczajka/brooklyn/blob/main/test/test.2.asm)
